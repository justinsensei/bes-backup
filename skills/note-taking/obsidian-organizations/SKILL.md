...
description: Use when creating or updating contact notes representing company, school,
  or institutional entities under Contacts/ or inbox/ with category "[[Organizations]]".
version: 1.1.0
author: Bes
license: MIT
metadata:
