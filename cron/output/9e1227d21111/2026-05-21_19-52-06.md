...
- id=19e4cf37316833f4 from='Justin Goff <goff.justin@gmail.com>' subject='Fwd: Automatic Payment Reminder for Winchester Thurston School' snippet='Create a task in Todoist: figure out why these tuition numbers are different. Top priority. ---------- Forwarded message ---------- From: Cu'
```
...
✅ Automatic Payment Reminder for Winchester Thurston School → created P1 Todoist task "Figure out why these tuition numbers are different" (due today, inbox)
