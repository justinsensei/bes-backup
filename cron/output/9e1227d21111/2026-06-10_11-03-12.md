...
ERROR: poll_bes_inbox: gmail search failed (rc=1): Traceback (most recent call last):
  ...
  File "/home/justin.guest/.hermes/skills/productivity/google-workspace/scripts/google_api.py", line 1280, in main
    args.func(args)
  File "/home/justin.guest/.hermes/skills/productivity/google-workspace/scripts/google_api.py", line 282, in gmail_search
    ).execute()
      ^^^^^^^^^
  File "/home/justin.guest/.hermes/hermes-agen
```
...
The inbox poller failed with a Gmail search error.

It looks like a transient Google API or network issue—I ran the search manually just now and it connected successfully with no errors. I will check again on the next run.
